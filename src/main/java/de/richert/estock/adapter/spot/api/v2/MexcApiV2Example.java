package de.richert.estock.adapter.spot.api.v2;

import com.fasterxml.jackson.core.type.TypeReference;
import com.google.common.collect.ImmutableMap;
import com.google.common.collect.Maps;
import com.google.gson.Gson;
import de.richert.estock.adapter.spot.api.v2.pojo.Asset;
import de.richert.estock.adapter.spot.api.v2.pojo.Balance;
import de.richert.estock.adapter.spot.api.v2.pojo.CoinList;
import de.richert.estock.adapter.spot.api.v2.pojo.DepositAddressDto;
import de.richert.estock.adapter.spot.api.v2.pojo.DepositRecordDto;
import de.richert.estock.adapter.spot.api.v2.pojo.InternalTransferRecord;
import de.richert.estock.adapter.spot.api.v2.pojo.InternalTransferResult;
import de.richert.estock.adapter.spot.api.v2.pojo.MarketDepthWrapper;
import de.richert.estock.adapter.spot.api.v2.pojo.OpenOrderResp;
import de.richert.estock.adapter.spot.api.v2.pojo.OrderDealsResp;
import de.richert.estock.adapter.spot.api.v2.pojo.OrderResp;
import de.richert.estock.adapter.spot.api.v2.pojo.Pagination;
import de.richert.estock.adapter.spot.api.v2.pojo.PlaceOrderRequest;
import de.richert.estock.adapter.spot.api.v2.pojo.Result;
import de.richert.estock.adapter.spot.api.v2.pojo.SymbolInfo;
import de.richert.estock.adapter.spot.api.v2.pojo.TickerInfo;
import de.richert.estock.adapter.spot.api.v2.pojo.TradeHistory;
import de.richert.estock.adapter.spot.api.v2.pojo.WithdrawAddress;
import de.richert.estock.adapter.spot.api.v2.pojo.WithdrawApply;
import de.richert.estock.adapter.spot.api.v2.pojo.WithdrawRecord;
import de.richert.estock.common.JsonUtil;
import de.richert.estock.common.SignatureUtil;
...
public class MexcApiV2Example {
  ...
  public Result<Pagination<InternalTransferRecord>> internalTransferRecord(Map<String, String> params) {
    return get("/open/api/v2/asset/internal/transfer/record", params, true,
        new TypeReference<Result<Pagination<InternalTransferRecord>>>() {
        });
  }
  ...
  public static void main(String[] args) {
    ...
    Result<Pagination<DepositRecordDto>> depositRecordList = example.depositRecordList(
    ...
    Result<Pagination<WithdrawAddress>> withdrawAddressList = example.withdrawAddressList(
        Maps.newHashMap(ImmutableMap.<String, String>builder()
            .put("currency", "USDT")
            .build()));
    ...
    //get transfer record
    Result<Pagination<InternalTransferRecord>> transferRecord = example.internalTransferRecord(
        Maps.newHashMap(ImmutableMap.<String, String>builder()
            .put("currency", "USDT")
            .build()));
